...
const Triceps = ({ navigation }) => {
  ...
  const handleItemPress = (item) => {
    navigation.navigate('Train', { exerciseName: item, muscleGroup: 'Triceps' }); // Added muscleGroup
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Triceps Exercises</Text>
        ...
        renderItem={({ item, index }) => (
          <View style={styles.listItem}>
            {isEditing && editIndex === index ? (
              <View style={styles.editContainer}> {/* Use consistent editContainer style */}
                <TextInput
                  ...
                  autoFocus={true}
                />
                <TouchableOpacity onPress={handleSaveEdit} style={styles.editButton}> {/* Use consistent editButton style */}
                  <Text style={styles.saveButtonText}>Save</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={handleCancelEdit} style={styles.editButton}> {/* Use consistent editButton style */}
...
const styles = StyleSheet.create({
  ...
  editContainer: { // Consistent style
    flexDirection: 'row',
    flex: 1,
    alignItems: 'center',
  },
  editInput: { // Unused style removed
    flex: 1,
    borderWidth: 1,
    borderColor: '#3498DB',
    borderRadius: 6,
