...
const Hamstrings = ({ navigation }) => { 
  const [exercises, setExercises] = useState([
    ...
    'Glute Bridges',
    'Hyperextensions',
    'Deadlifts', // Hamstrings are significantly involved in deadlifts
  ]);
  ...
  const handleItemPress = (item) => {
    navigation.navigate('Train', { exerciseName: item, muscleGroup: 'Hamstrings' }); 
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Hamstrings Exercises</Text> 
