...
const Forearms = ({ navigation }) => { 
  const [exercises, setExercises] = useState([
    'Wrist Curls (Hammer Grips)',
    'Wrist Curls (Reverse Grips)',
    'Reverse Wrist Curls',
    'Wrist Rollers',
    'Farmer\'s Walks',
  ]);
  ...
  const handleItemPress = (item) => {
    navigation.navigate('Train', { exerciseName: item, muscleGroup: 'Forearms' }); 
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Forearm Exercises</Text> 
