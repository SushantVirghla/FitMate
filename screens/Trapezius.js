...
const Trapezius = ({ navigation }) => { 
  ...
  const handleItemPress = (item) => {
    navigation.navigate('Train', { exerciseName: item, muscleGroup: 'Trapezius' }); // Added muscleGroup
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Trapezius Exercises</Text> 
...
const styles = StyleSheet.create({
  ...
  editInput: { // Unused, can be removed
    flex: 1,
    borderWidth: 1,
    borderColor: '#3498DB',
    borderRadius: 6,
